...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    role: "Finance",
    image: "/univadev.svg",
    bio: "My name is Kyle Cheng and I am currently a Grade 12 IB student at Merivale High School. I am interested in biomedical engineering, cancer research and machine learning. I regularly compete in science fairs and am excited to helps others develop a passion for STEM.",
  ...
  },
  {
    ...
    role: "Marketing",
    image: "/univadev.svg",
    bio: "Eric Wang is a Grade 12 IB student at Merivale High School. He has a diverse background in leadership and caretaking roles, passionate about empowering students and is so excited to learn and contribute in this STEM environment!",
  ...
  },
  {
    ...
    role: "Technology",
    image: "/univadev.svg",
    bio: "Hi my name is Ryan, I’m a grade 12 student at LDHSS with a passion for coding, technology and problem solving. I love turning ideas into projects and exploring new challenges.",
