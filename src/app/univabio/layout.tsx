...
export const metadata: Metadata = {
  ...
  description:
    "UnivaBio is a global student hackathon hosted by Univa Dev and BioCataalysis. Build technology for human health. $35K+ in prizes, fully online, submissions due October 6, 2026.",
};
